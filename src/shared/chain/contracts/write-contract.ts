...
function decodeDryRunRevertReason(
  ...
  try {
    ...
    // Fall through to raw data fallback.
  }
...
export async function writeContract(
  ...
  // The first write from a fresh product account MUST map it once.
  // Subsequent writes skip this path after `OriginalAccount` exists.
  if (!isMapped) {
    try {
