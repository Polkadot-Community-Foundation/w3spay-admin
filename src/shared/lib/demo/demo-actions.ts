...
// Synthetic tx hash for demo write actions. Uses WebCrypto when available,
// falls back to Math.random where it isn't (no security implications: demo
// telemetry, not entropy).
